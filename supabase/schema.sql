...
create policy "public read data providers" on public.data_providers for select using (true);
...
create index provider_team_mappings_provider_team_idx on public.provider_team_mappings (provider_id, provider_team_id);
create index provider_fixture_mappings_provider_fixture_idx on public.provider_fixture_mappings (provider_id, provider_fixture_id);
create index provider_fixture_mappings_last_synced_idx on public.provider_fixture_mappings (last_synced_at desc);
